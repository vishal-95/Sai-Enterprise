<?php include("header.php");?>
    ...
    <div class="about-team"> 
		<div class="container">
			<h3 class="title1">Toiletry Products</h3>
			<div class="team-info">
				<div class="col-md-3 about-team-grids">
					<img src="images/p34.jpg" alt=""/>
					<div class="team-text">
						<h4><span>Air Freshener</span></h4>
						<p></p>
					</div>
                ...
                <div class=" col-md-3 about-team-grids">
					...
					<div class="team-text">
						<h4><span>Soap Dispenser</span></h4>
						<p></p>
					</div>
               ...
               <div class="col-md-3 about-team-grids">
				...
				<div class="col-md-3 about-team-grids">
					...
					<div class="team-text">
						<h4><span>M Fold & HRT Rolls</span></h4>				
						<p></p>
					</div>
                ...
                <div class="col-md-3 about-team-grids">
					...
					<div class="team-text">
						<h4><span>Toilet Rolls & JRT Rolls</span></h4>
						<p></p>
					</div>
                ...
                <div class="col-md-3 about-team-grids">
					...
					<div class="team-text">
						<h4><span>Face Tissues & Napkins</span></h4>
						<p></p>
					</div>
                ...
                <div class="col-md-3 about-team-grids">
					...
					<div class="team-text">
						<h4><span>Hand Wash & Hand Sanitizer</span></h4>
						<p></p>
					</div>
